    ...
    describe('Salary Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/salaries';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Salary', () => {
                service.create(new Salary(null)).subscribe(received => {
            ...
            it('should update a Salary', () => {
                service.update(new Salary(123)).subscribe(received => {
