...
import { CourseTypeComponent } from 'app/entities/course-type/course-type.component';
...
describe('Component Tests', () => {
    describe('CourseType Management Component', () => {
        let comp: CourseTypeComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(CourseTypeComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.courseTypes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
