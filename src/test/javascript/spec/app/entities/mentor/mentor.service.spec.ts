    ...
    describe('Mentor Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/mentors';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Mentor', () => {
                service.create(new Mentor(null)).subscribe(received => {
            ...
            it('should update a Mentor', () => {
                service.update(new Mentor(123)).subscribe(received => {
