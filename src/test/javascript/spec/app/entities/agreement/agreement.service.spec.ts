    ...
    describe('Agreement Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/agreements';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Agreement', () => {
                service.create(new Agreement(null)).subscribe(received => {
            ...
            it('should update a Agreement', () => {
                service.update(new Agreement(123)).subscribe(received => {
