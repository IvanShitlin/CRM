...
import { SalaryItemComponent } from 'app/entities/salary-item/salary-item.component';
...
describe('Component Tests', () => {
    describe('SalaryItem Management Component', () => {
        let comp: SalaryItemComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(SalaryItemComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.salaryItems[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
