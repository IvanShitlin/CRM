...
import com.foxminded.hipsterfox.domain.enumeration.TaskPriority;
import com.foxminded.hipsterfox.domain.enumeration.TaskType;
...
import com.foxminded.hipsterfox.repository.TaskRepository;
...
public class AgreementResourceIntTest {
     ...
     *
     * @see com.foxminded.hipsterfox.repository.search.AgreementSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void checkImpossibleToSaveDuplicateAgreement() throws Exception {
        ...
        restAgreementMockMvc.perform(post("/api/agreements")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(agreementMapper.toDto(duplicateAgreement))))
            .andExpect(status().isBadRequest());
