...
import ru.shitlin.repository.PaymentRepository;
import ru.shitlin.service.PaymentService;
import ru.shitlin.service.dto.PaymentDTO;
import ru.shitlin.service.mapper.PaymentMapper;
...
public class PaymentResourceIntTest {
    ...
    public void createPayment() throws Exception {
        ...
        restPaymentMockMvc.perform(post("/api/payments")
            ...
            .content(ru.shitlin.web.rest.TestUtil.convertObjectToJsonBytes(paymentDTO)))
        ...
        assertThat(testPayment.getSum()).isEqualTo(new Money(DEFAULT_AMOUNT, DEFAULT_CURRENCY));
    }
    ...
    public void checkSumCurrencyIsRequired() throws Exception {
        int databaseSizeBeforeTest = paymentRepository.findAll().size();
        // set the field null
        payment.getSum().setCurrency(null);
    ...
    public void updatePayment() throws Exception {
        ...
        updatedPayment
            .date(UPDATED_DATE)
            .sum(payment.getSum().amount(UPDATED_AMOUNT).currency(UPDATED_CURRENCY));
        ...
        assertThat(testPayment.getSum()).isEqualTo(new Money(UPDATED_AMOUNT, UPDATED_CURRENCY));
    }
    ...
    public void checkSumAmountIsRequiredForUpdate() throws Exception {
        ...
        em.detach(updatedPayment);
        // set field null
        updatedPayment.getSum().setAmount(null);
        PaymentDTO paymentDTO = paymentMapper.toDto(updatedPayment);
    ...
    public void checkSumCurrencyIsRequiredForUpdate() throws Exception {
        ...
        em.detach(updatedPayment);
        // set field null
        updatedPayment.getSum().setCurrency(null);
        PaymentDTO paymentDTO = paymentMapper.toDto(updatedPayment);
    ...
    public void equalsVerifier() throws Exception {
        ru.shitlin.web.rest.TestUtil.equalsVerifier(Payment.class);
