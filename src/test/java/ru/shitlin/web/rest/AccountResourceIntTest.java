...
import ru.shitlin.domain.Authority;
import ru.shitlin.domain.PersistentToken;
import ru.shitlin.domain.User;
import ru.shitlin.repository.AuthorityRepository;
import ru.shitlin.repository.PersistentTokenRepository;
...
import ru.shitlin.service.UserService;
import ru.shitlin.service.dto.PasswordChangeDTO;
import ru.shitlin.service.dto.UserDTO;
import ru.shitlin.web.rest.errors.ExceptionTranslator;
import ru.shitlin.web.rest.vm.KeyAndPasswordVM;
import ru.shitlin.web.rest.vm.ManagedUserVM;
...
public class AccountResourceIntTest {
    ...
    public void testRegisterValid() throws Exception {
        ...
        restMvc.perform(
            post("/api/register")
                ...
                .content(ru.shitlin.web.rest.TestUtil.convertObjectToJsonBytes(validUser)))
    ...
    public void testRegisterInvalidLogin() throws Exception {
        ...
        restUserMockMvc.perform(
            post("/api/register")
                .contentType(ru.shitlin.web.rest.TestUtil.APPLICATION_JSON_UTF8)
                .content(ru.shitlin.web.rest.TestUtil.convertObjectToJsonBytes(invalidUser)))
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        restMvc.perform(
            post("/api/register")
                .contentType(ru.shitlin.web.rest.TestUtil.APPLICATION_JSON_UTF8)
                .content(ru.shitlin.web.rest.TestUtil.convertObjectToJsonBytes(firstUser)))
            .andExpect(status().isCreated());
        ...
        restMvc.perform(
            post("/api/register")
                .contentType(ru.shitlin.web.rest.TestUtil.APPLICATION_JSON_UTF8)
                .content(ru.shitlin.web.rest.TestUtil.convertObjectToJsonBytes(secondUser)))
            .andExpect(status().isCreated());
    ...
    public void testRegisterDuplicateEmail() throws Exception {
        ...
        restMvc.perform(
            post("/api/register")
                .contentType(ru.shitlin.web.rest.TestUtil.APPLICATION_JSON_UTF8)
                .content(ru.shitlin.web.rest.TestUtil.convertObjectToJsonBytes(userWithUpperCaseEmail)))
            .andExpect(status().isCreated());
    ...
    public void testSaveAccount() throws Exception {
        ...
        restMvc.perform(
            post("/api/account")
                .contentType(ru.shitlin.web.rest.TestUtil.APPLICATION_JSON_UTF8)
                .content(ru.shitlin.web.rest.TestUtil.convertObjectToJsonBytes(userDTO)))
            .andExpect(status().isOk());
    ...
    public void testChangePasswordWrongExistingPassword() throws Exception {
        ...
        restMvc.perform(post("/api/account/change-password")
            .contentType(ru.shitlin.web.rest.TestUtil.APPLICATION_JSON_UTF8)
            .content(ru.shitlin.web.rest.TestUtil.convertObjectToJsonBytes(new PasswordChangeDTO("1"+currentPassword, "new password"))))
            .andExpect(status().isBadRequest());
    ...
    public void testChangePassword() throws Exception {
        ...
        restMvc.perform(post("/api/account/change-password")
            .contentType(ru.shitlin.web.rest.TestUtil.APPLICATION_JSON_UTF8)
            .content(ru.shitlin.web.rest.TestUtil.convertObjectToJsonBytes(new PasswordChangeDTO(currentPassword, "new password"))))
            .andExpect(status().isOk());
    ...
    public void testChangePasswordTooSmall() throws Exception {
        ...
        restMvc.perform(post("/api/account/change-password")
            .contentType(ru.shitlin.web.rest.TestUtil.APPLICATION_JSON_UTF8)
            .content(ru.shitlin.web.rest.TestUtil.convertObjectToJsonBytes(new PasswordChangeDTO(currentPassword, "new"))))
            .andExpect(status().isBadRequest());
    ...
    public void testChangePasswordTooLong() throws Exception {
        ...
        restMvc.perform(post("/api/account/change-password")
            .contentType(ru.shitlin.web.rest.TestUtil.APPLICATION_JSON_UTF8)
            .content(ru.shitlin.web.rest.TestUtil.convertObjectToJsonBytes(new PasswordChangeDTO(currentPassword, RandomStringUtils.random(101)))))
            .andExpect(status().isBadRequest());
    ...
    public void testFinishPasswordReset() throws Exception {
        ...
        restMvc.perform(
            post("/api/account/reset-password/finish")
                .contentType(ru.shitlin.web.rest.TestUtil.APPLICATION_JSON_UTF8)
                .content(ru.shitlin.web.rest.TestUtil.convertObjectToJsonBytes(keyAndPassword)))
            .andExpect(status().isOk());
