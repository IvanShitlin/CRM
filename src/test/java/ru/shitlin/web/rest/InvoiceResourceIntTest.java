...
public class InvoiceResourceIntTest {
    ...
    public void createInvoice() throws Exception {
        ...
        Contract contract = ru.shitlin.web.rest.ContractResourceIntTest.createEntity(em);
        ...
        restInvoiceMockMvc.perform(post("/api/invoices")
            ...
            .content(ru.shitlin.web.rest.TestUtil.convertObjectToJsonBytes(invoiceDTO)))
    ...
    public void createWhenDateFirstContractPayAreLastDays() throws Exception {
        ...
        restInvoiceMockMvc.perform(post("/api/invoices")
            .contentType(ru.shitlin.web.rest.TestUtil.APPLICATION_JSON_UTF8)
            .content(ru.shitlin.web.rest.TestUtil.convertObjectToJsonBytes(invoiceDTO1)))
            .andExpect(status().isCreated());
    ...
    public void equalsVerifier() throws Exception {
        ru.shitlin.web.rest.TestUtil.equalsVerifier(Invoice.class);
