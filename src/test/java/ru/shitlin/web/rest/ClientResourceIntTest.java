...
import ru.shitlin.service.ClientQueryService;
...
public class ClientResourceIntTest {
    ...
    public void createClient() throws Exception {
        ...
        restClientMockMvc.perform(post("/api/clients")
            ...
            .content(ru.shitlin.web.rest.TestUtil.convertObjectToJsonBytes(clientDTO)))
    ...
    public void equalsVerifier() throws Exception {
        ru.shitlin.web.rest.TestUtil.equalsVerifier(Client.class);
