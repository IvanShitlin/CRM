...
public class ContractResourceIntTest {
    ...
    public void createContract() throws Exception {
        ...
        restContractMockMvc.perform(post("/api/contracts")
            ...
            .content(ru.shitlin.web.rest.TestUtil.convertObjectToJsonBytes(contractDTO)))
    ...
    public void equalsVerifier() throws Exception {
        ru.shitlin.web.rest.TestUtil.equalsVerifier(Contract.class);
    ...
    public void dtoEqualsVerifier() throws Exception {
        ru.shitlin.web.rest.TestUtil.equalsVerifier(ContractDTO.class);
    ...
    public void getAllContractsByAgreementIsEqualToSomething() throws Exception {
        // Initialize the database
        Agreement agreement = ru.shitlin.web.rest.AgreementResourceIntTest.createEntity(em);
