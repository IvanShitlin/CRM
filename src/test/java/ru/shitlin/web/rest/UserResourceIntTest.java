...
import ru.shitlin.service.mapper.UserMapper;
...
public class UserResourceIntTest {
     ...
     *
     * @see com.foxminded.hipsterfox.repository.search.UserSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createUser() throws Exception {
        ...
        restUserMockMvc.perform(post("/api/users")
            ...
            .content(ru.shitlin.web.rest.TestUtil.convertObjectToJsonBytes(managedUserVM)))
