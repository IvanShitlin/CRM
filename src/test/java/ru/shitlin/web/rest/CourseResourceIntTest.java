...
public class CourseResourceIntTest {
    ...
    private static final byte[] DEFAULT_IMAGE = ru.shitlin.web.rest.TestUtil.createByteArray(1, "0");
    private static final byte[] UPDATED_IMAGE = ru.shitlin.web.rest.TestUtil.createByteArray(2, "1");
    ...
    public void createCourse() throws Exception {
        ...
        restCourseMockMvc.perform(post("/api/courses")
            ...
            .content(ru.shitlin.web.rest.TestUtil.convertObjectToJsonBytes(courseDTO)))
    ...
    public void getAllCoursesByMentorsIsEqualToSomething() throws Exception {
        // Initialize the database
        Mentor mentor = ru.shitlin.web.rest.MentorResourceIntTest.createEntity(em);
        em.persist(mentor);
        em.flush();
    ...
    public void equalsVerifier() throws Exception {
        ru.shitlin.web.rest.TestUtil.equalsVerifier(Course.class);
