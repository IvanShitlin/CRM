...
import ru.shitlin.repository.CourseTypeRepository;
import ru.shitlin.service.CourseTypeService;
import ru.shitlin.service.dto.CourseTypeDTO;
import ru.shitlin.service.mapper.CourseTypeMapper;
...
public class CourseTypeResourceIntTest {
    ...
    public void createCourseType() throws Exception {
        ...
        restCourseTypeMockMvc.perform(post("/api/course-types")
            ...
            .content(ru.shitlin.web.rest.TestUtil.convertObjectToJsonBytes(courseTypeDTO)))
    ...
    public void equalsVerifier() throws Exception {
        ru.shitlin.web.rest.TestUtil.equalsVerifier(CourseType.class);
