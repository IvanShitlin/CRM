...
import ru.shitlin.service.SalaryItemQueryService;
...
public class SalaryItemResourceIntTest {
    ...
    public void createSalaryItem() throws Exception {
        ...
        restSalaryItemMockMvc.perform(post("/api/salary-items")
            ...
            .content(ru.shitlin.web.rest.TestUtil.convertObjectToJsonBytes(salaryItemDTO)))
    ...
    public void equalsVerifier() throws Exception {
        ru.shitlin.web.rest.TestUtil.equalsVerifier(SalaryItem.class);
