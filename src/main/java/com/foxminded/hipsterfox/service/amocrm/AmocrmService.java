...
import com.foxminded.hipsterfox.repository.AmocrmInfoRepository;
import com.foxminded.hipsterfox.service.ClientService;
import com.foxminded.hipsterfox.service.amocrm.mapper.AmocrmClientMapper;
import com.foxminded.hipsterfox.service.amocrm.model.AmocrmContact;
...
import static com.foxminded.hipsterfox.service.amocrm.util.AmocrmTimeConverter.toAmocrmRequestFormat;
import static com.foxminded.hipsterfox.service.amocrm.util.AmocrmTimeConverter.toZoneDateTime;
...
public class AmocrmService {
    ...
    private ContactImportData getAllContacts(Integer limitRows, Integer limitOffset, ZonedDateTime syncSince) {
        ...
        headers.add("IF-MODIFIED-SINCE", toAmocrmRequestFormat(syncSince));
    ...
    private static ZonedDateTime extractAmocrmImportDate(ResponseEntity<Resources<AmocrmContact>> response) {
        ...
        if (headerValues != null && headerValues.size() != 0) {
            amocrmImportDate = toZoneDateTime(headerValues.get(0));
        }
