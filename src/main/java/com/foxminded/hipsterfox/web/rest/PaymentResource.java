...
public class PaymentResource {
    ...
    @Timed
    public ResponseEntity<PaymentDTO> createPayment(@RequestBody @Valid PaymentDTO paymentDTO) throws URISyntaxException {
    ...
    @PutMapping("/payments")
    @Timed
    public ResponseEntity<PaymentDTO> updatePayment(@RequestBody @Valid PaymentDTO paymentDTO) throws URISyntaxException {
