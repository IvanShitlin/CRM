package ru.shitlin.config.audit;

import com.fasterxml.jackson.databind.ObjectMapper;
import ru.shitlin.domain.AbstractAuditingEntity;
import ru.shitlin.domain.EntityAuditEvent;
import ru.shitlin.repository.EntityAuditEventRepository;
