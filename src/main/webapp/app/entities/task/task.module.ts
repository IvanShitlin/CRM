...
import { HipsterfoxAdminModule } from 'app/admin/admin.module';
import {
    TaskComponent,
    TaskDetailComponent,
    TaskUpdateComponent,
...
@NgModule({
    imports: [HipsterfoxSharedModule, HipsterfoxAdminModule, RouterModule.forChild(ENTITY_STATES)],
...
export class HipsterfoxTaskModule {}
