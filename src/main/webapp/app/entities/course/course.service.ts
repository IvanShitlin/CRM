...
export class CourseService {
    ...
    assignMentor(mentorId: number, courseId: number) {
        return this.http.put<ICourse>(`${this.resourceUrl}/${courseId}/${this.mentorPath}/${mentorId}`, { observe: 'response' });
    }

    deleteMentor(mentorId: number, courseId: number): Observable<HttpResponse<any>> {
        return this.http.delete<any>(`${this.resourceUrl}/${courseId}/${this.mentorPath}/${mentorId}`, { observe: 'response' });
    }
}
